...
class PackageManagerTest extends TestCase
{
    ...
    public function testBasic()
    {
        ...
        $this->pm->addPackages([
            'package2' => ['source_path' => 'source_path2'],
            'package3' => ['source_path' => 'source_path3'],
        ]);
    ...
    {
        $this->pm->addPackages([
            'package1' => ['source_path' => 'source_path1'],
            'package2' => ['source_path' => 'source_path2'],
        ]);
    ...
    {
        $this->assertSame([], $this->pm->getPackages());
