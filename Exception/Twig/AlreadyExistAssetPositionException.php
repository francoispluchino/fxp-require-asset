...
/**
 * AlreadyExistAssetPositionException for the already exist the twig function of asset position.
 *
 * @author François Pluchino <francois.pluchino@gmail.com>
 */
class AlreadyExistAssetPositionException extends RuntimeException
{
    /**
     * Constructor.
     *
     * @param string      $category The twig asset category
     * @param string      $type     The twig asset type
